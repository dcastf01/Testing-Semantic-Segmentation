...
def unet_conv_block(x, filters, kernel_size=3, batch_norm=True, dropout=False,activation=None,
    ...
    # First convolution:
    x = Conv2D(filters, kernel_size=kernel_size, activation=activation,
...
def unet_deconv_block(x, filters, kernel_size=2, strides=2, batch_norm=True, dropout=False,activation=None,
...
def unet(x, out_channels=3, layer_depth=4, filters_orig=32, kernel_size=4,activation_intermediate=None,
    ...
    for i in range(layer_depth):
        conv_block = unet_conv_block(x, filters, kernel_size,activation=activation_intermediate,
    ...
    for i in range(layer_depth):
        ...
        deconv_block = unet_deconv_block(x, filters, kernel_size,activation=activation_intermediate,
